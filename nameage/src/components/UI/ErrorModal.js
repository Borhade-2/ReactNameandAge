...
const ErrorModal =(props)=>{
 ...
 //here we have taken the property name as onconfirm bcz in backdrop we haver taken props.onconfirm 

// we add here onClick because when we click on outside modalbox it should be gone
